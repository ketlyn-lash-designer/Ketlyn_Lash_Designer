...
saveBtn.addEventListener("click", function () {
  ...
  // document.getElementById("lembrete").style.backgroundSize = "100% 100%";
  document.getElementById("lembrete").style.backgroundPosition = "center";
  document.getElementById("lembrete").style.backgroundAttachment = "fixed";
  document.getElementById("lembrete").style.backgroundRepeat = "no-repeat";
  document.getElementById("lembrete").style.overflow = "hidden";
