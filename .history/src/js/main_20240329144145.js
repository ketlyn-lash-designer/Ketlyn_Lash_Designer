...
saveBtn.addEventListener("click", function () {
  ...
  document.getElementById("imagem").style.width = "200px"; // Exemplo de definição de largura
  document.getElementById("imagem").style.height = "200px"; // Exemplo de definição de altura
