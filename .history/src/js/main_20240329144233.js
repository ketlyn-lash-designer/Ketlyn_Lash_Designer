...
saveBtn.addEventListener("click", function () {
  ...
  document.getElementById("lembrete").style.width = "200px"; // Exemplo de definição de largura
  document.getElementById("lembrete").style.height = "200px"; // Exemplo de definição de altura
