...
const saveBtn = document.getElementById("saveBtn"); const datepicker = document.getElementById("datepicker"); const timepicker = document.getElementById("timepicker");

saveBtn.addEventListener("click", function() { const date = datepicker.value; const time = timepicker.value; alert(Seu atendimento foi marcado para o dia ${date} às ${time} horas.); });